...
public class RPDocumentCreationForAmountDueForeign {
	...
	public static WebDriver RP_Advance(WebDriver driver, String documentID, String customerid, String EnterAmount,
		...
		try {
			...
			String documentID1 = "RPAD" + documentID;
	...
	public static WebDriver RP_Invoice(WebDriver driver, String documentID, String vendorid, String PaymentMethod) {
		try {
	...
	public static WebDriver RP_DebitNote(WebDriver driver, String documentID, String vendorid, String PaymentMethod) {
		try {
	...
	public static WebDriver RPCust_RE(String documentID, String vendorid, WebDriver driver, String PaymentMethod) {
	...
	public static WebDriver RPCust_DE(String documentID, String vendorid, WebDriver driver, String PaymentMethod) {
