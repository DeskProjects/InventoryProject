...
public class LeaseSalesReturn {
	...
	public static void VerifyLM_SalesReturn(String documentid, String productid, String customerid, WebDriver driver)
	...
	public void Delete_LeaseReturn(String documentid1, String productid, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			 ...
			 * getProperty("reportCheckBox")))); checkbox.click();
			 * Thread.sleep(2000);
			 * 
			 * 
			 * WebElement editcustomerButton =
			 * wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.
			 * getProperty("EditLSRbutton")))); editcustomerButton.click();
			 * Thread.sleep(3000);
			 * 
			 * WebElement LCQmemo =
			 * wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.
			 * getProperty("EditMemo")))); LCQmemo.sendKeys("EditMemo");
			 * Thread.sleep(3000);
			 * 
			 * new WebDriverWait(driver,30).until(ExpectedConditions.
			 * elementToBeClickable(By.xpath(pro.getProperty("buttonSave"))));
			 ...
			 * 
			 * WebElement clsEditBtn = new
			 * WebDriverWait(driver,30).until(ExpectedConditions.
			 * elementToBeClickable(By.xpath(pro.getProperty("closeEditWin"))));
			 * clsEditBtn.click();
			 * 
			 * 
			 * Thread.sleep(3000); search.clear(); Thread.sleep(1000);
			 * search.sendKeys(documentid1); search.sendKeys(Keys.TAB);
			 * Thread.sleep(3000);
			 */
