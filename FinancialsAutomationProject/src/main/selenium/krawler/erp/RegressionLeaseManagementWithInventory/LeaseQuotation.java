...
public class LeaseQuotation {
	...
	public static void VerifyLM_Quotation(String documentid, String productid, String customerid, WebDriver driver)
	...
	public void EditDelete_CustomerQuotation(String documentid1, String productid, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
