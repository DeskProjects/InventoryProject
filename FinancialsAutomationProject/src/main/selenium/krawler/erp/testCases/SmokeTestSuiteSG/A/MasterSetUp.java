...
public class MasterSetUp extends BaseSetUp {
	public String dateType1 = Utilities.currentDate("dd-MM-yyyy"); // set
																	// dd-mm-yyyy
	public String dateFormat2 = Utilities.currentDate("yyyy-MM-dd"); // set
																		// yyyy-mm-dd

	// Chart of Account
	@Test(priority = 10, groups = { "Create" })
	public void Create_COA() throws InterruptedException, IOException, AWTException {
		ChartOfAccount.create_ChartOfAccount("COA" + documentid, "Balance Sheet", "Bank", "Bank", driver);
	...
	public void Verify_COA() throws InterruptedException, IOException, AWTException {
		ChartOfAccount.verify_ChartOfAccount("COA" + documentid, driver);
	}
	...
	@Test(priority = 13, groups = { "Import" })
	...
	@Test(priority = 43, groups = { "Audit Trail" })
	...
	@Test(priority = 44, groups = { "Import" })
	...
	@Test(priority = 45, groups = { "Export" })
	...
	public void Create_Tax() throws InterruptedException, IOException, AWTException {
		ChartOfAccount.create_ChartOfAccount("GST" + documentid, "Balance Sheet", "GST", "Other Current Liability",
				driver);
	...
	public void CopyEditDelete_Tax() throws InterruptedException, IOException, AWTException {
		Taxes.create_Tax(documentid + "deleteTC", "8", "GST" + documentid, driver);
		Taxes.delete_Tax(documentid + "deleteTC", driver);
	}
	...
	public void create_PaymentMethod() throws InterruptedException, IOException, AWTException {
		...
		// PaymentMethod.create_PaymentMethod(documentid+"Ex", accName, "Yes",
		// "Yes", driver);
		// PaymentMethod.verify_EditDeletePaymentMethod(documentid+"Ex",
		// accName, driver);
	}
