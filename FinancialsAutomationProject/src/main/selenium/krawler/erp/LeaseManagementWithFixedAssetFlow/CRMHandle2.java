...
public class CRMHandle2 {
	...
	public void CRM_MaintenanceRequest(WebDriver driver, String customerid, String documentid, String Asset_ID)
		...
		try {
			...
			String itemName = Asset_ID + "BS Name";
	...
	public void CRM_ReplacementRequest(WebDriver driver, String customerid, String documentid, String Asset_ID)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = "contract" + documentid;
			Properties LM = Utilities.fetchProValue("OR_CRM.properties");
			...
			action.moveToElement(driver.findElement(By.xpath(LM.getProperty("ProductSelection0")))).doubleClick()
					.perform();
			selectFromNormalDropDown(Asset_ID + "BS Name", LM.getProperty("ProductSelection1"), driver);
