...
public class OpeningCustomerDNCreation {

	public void Create_OPCustomerDN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustDN";
			...
			// Click on Debit Note Tab
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("DNTab")))).click();
			...
			// Fill the information for Opening Customer DN document
			...
			System.out.println(
					"\"Opening Customer Debit Note\" is created successfully with Base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Customer DN is not created");
	...
	// ------------------------------------------- Opening Customer DN with
	// Foreign
	// Currency---------------------------------------------------------------------

	public void Create_OPCustomerDN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			Thread.sleep(3000);
			...
			System.out.println(
					"\"Opening Customer Debit Note\" is created successfully with foreign currency: " + documentid1);
	...
	// --------------------------------------------------------------Edit
	// Opening Customer DN Document(Base
	// Currency)--------------------------------------

	public void Edit_OPCustomerDN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			driver.findElement(By.xpath(pro.getProperty("OpeningMemo")))
					.sendKeys("Edit Opening Customer DN by Automation Script");
			Thread.sleep(1000);
			...
			System.out.println(
					"\"Opening Customer Debit Note\" is edited successfully with base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Customer DN is not edited");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}
	...
	// --------------------------------------------------------------Edit
	// Opening Customer DN Document(Foreign
	// Currency)--------------------------------------

	public void Edit_OPCustomerDN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			System.out.println(
					"\"Opening Customer Debit Note\" is edited successfully with foreign currency: " + documentid1);
	...
	public void Delete_OPCustomerDN_With_BaseandForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			System.out.println("Opening Customer Debit Notes are deleted successfully");

		} catch (Exception EX) {
			System.out.println("Opening Customer DN are not deleted");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}

	// ----------------------------------------Again Create Opening Customer DN
	// with Base and Foreign Currency-------------------------------------------

	public void Create_OPCustomerDN_With_BaseCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			// Fill the information for Opening Customer Debit Note document
	...
	public void Create_OPCustomerDN_With_ForeignCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
	...
	// --------------------------------------- Verify Opening Customer Debit
	// Note document through Credit Note
	// Report--------------------------------------------

	public void OpeningCustomerDNDocument_Verifcation(WebDriver driver, String CustomerID)
			throws IOException, InterruptedException, AWTException {
		try {
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			Thread.sleep(1000);

			// Open Debit Note Report
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("DNReport")))).click();
			Thread.sleep(2000);
			...
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("Opendocusel2")))).click();
			Thread.sleep(2000);
			...
			if (expected.equalsIgnoreCase(actual)) {
				System.out.println("Opening Customer Debit Note records are shown successfully");
			}
		} catch (Exception EX) {
			System.out.println("No Opening Customer Debit Note record is shown");
