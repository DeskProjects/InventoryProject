...
public class GST_Input_Rule

{

	public static void Import_Input_GST_Rule(WebDriver driver) throws InterruptedException, AWTException, IOException

	{
...

		{
			...
			WebElement GST_Input_Rule_Report = wait.until(
					ExpectedConditions.elementToBeClickable(By.xpath(GST_pro.getProperty("GST_Input_Rule_Report"))));
			GST_Input_Rule_Report.click();
			Thread.sleep(500);
			...
			String filPathCSV = Utilities.importFile("InputGST.csv");
...

			{
				...
				System.out.println("Input Import rules added successfully");
