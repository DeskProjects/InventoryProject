...
public class OpeningCustomerCNCreation {
	public void Create_OPCustomerCN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustCN";
			...
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("CNTab")))).click();
			...
			// Fill the information for Opening Customer CN document
			...
			System.out.println(
					"\"Opening Customer Credit Note\" is created successfully with Base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Customer CN is not created");
	...
	// ------------------------------------------- Opening Customer CN with
	// Foreign
	// Currency---------------------------------------------------------------------

	public void Create_OPCustomerCN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
			Thread.sleep(3000);
			...
			System.out.println(
					"\"Opening Customer Credit Note\" is created successfully with foreign currency: " + documentid1);
	...
	// --------------------------------------------------------------Edit
	// Opening Customer CN Document(Base
	// Currency)--------------------------------------

	public void Edit_OPCustomerCN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
			...
			driver.findElement(By.xpath(pro.getProperty("OpeningMemo")))
					.sendKeys("Edit Opening Customer CN by Automation Script");
			Thread.sleep(1000);
			...
			System.out.println(
					"\"Opening Customer Credit Note\" is edited successfully with base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Customer CN is not edited");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}
	...
	// --------------------------------------------------------------Edit
	// Opening Customer CN Document(Foreign
	// Currency)--------------------------------------

	public void Edit_OPCustomerCN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
			...
			System.out.println(
					"\"Opening Customer Credit Note\" is edited successfully with foreign currency: " + documentid1);
	...
	public void Delete_OPCustomerCN_With_BaseandForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
			...
			System.out.println("Opening Customer Credit Notes are deleted successfully");

		} catch (Exception EX) {
			System.out.println("Opening Customer CN are not deleted");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}

	// ----------------------------------------Again Create Opening Customer CN
	// with Base and Foreign Currency-------------------------------------------

	public void Create_OPCustomerCN_With_BaseCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
			...
			// Fill the information for Opening Customer Credit Note document
	...
	public void Create_OPCustomerCN_With_ForeignCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignCustCN";
			Properties pro = Utilities.fetchProValue("OR_CreditNoteOtherwise.properties");
	...
	// --------------------------------------- Verify Opening Customer Credit
	// Note document through Credit Note
	// Report--------------------------------------------

	public void OpeningCustomerCNDocument_Verifcation(WebDriver driver, String CustomerID)
		...
		try {
			...
			if (expected.equalsIgnoreCase(actual)) {
				System.out.println("Opening Customer Credit Note records are shown successfully");
			}
		} catch (Exception EX) {
			System.out.println("No Opening Customer Credit Note record is shown");
