...
public class OpenProductReplacement1 {
	...
	public void LM_VerifyProductReplcaement(String expected, WebDriver driver)
		...
		try {
			...
			if (expResul.equals(expected)) {
				System.out.println("Product Replacement Report is getting opened Successfully");
			} else {
				System.out.println("Product Replacement Report is not getting opened");
			}
			Utilities.refresh();
		} catch (Exception EX) {
