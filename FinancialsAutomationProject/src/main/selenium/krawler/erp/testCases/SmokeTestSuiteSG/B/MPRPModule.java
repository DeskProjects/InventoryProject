...
public class MPRPModule extends BaseSetUp {
	...
	@Test(priority = 561, groups = { "Create" })
	...
	@Test(priority = 562, groups = { "Create" })
	public void create_makePaymentAgainstGL_ChequePrint() throws InterruptedException, IOException, AWTException {
		...
		String accType = "Utilities";
		MakePaymentAgainstGL.create_makePayment_GL_PrintCheque(documentid, customerid, accType, payMethod, "chqNo21",
				driver);
	}

	@Test(priority = 563, groups = { "Create" })
	public void create_JEfundTransfer_ChequePrint() throws InterruptedException, IOException, AWTException {
		FundTransferJE.create_fundTransferJE_PrintCheque(documentid, payMethod, "ChqJE001", driver);
		Utilities.refresh();
	}
	...
	public void Create_JENormal() throws InterruptedException, IOException, AWTException {
		JENormal.create_normalJE(documentid, "Utilities", "Utilities", driver);
	}
	...
	public void Create_JEParty() throws InterruptedException, IOException, AWTException {
		PartyJE.create_partyJE(documentid, "Utilities", "Utilities", driver);
	}
	...
	@Test(priority = 591, groups = { "Verify" })
	...
	@Test(priority = 593, groups = { "Audit Trail" })
	...
	@Test(priority = 594, groups = { "Export" })
