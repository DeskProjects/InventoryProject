	...
	public static void Export_TodayDate(String buttonName, String reportIcon, String waitForQuickSearch,
		...
		try {
			...
			try {
				...
				/*
				 * // Excel in Details Utilities.clickButton(ExportButtonName,
				 * 500, driver); Actions action = new Actions(driver);
				 * WebElement hoverElement = new
				 * WebDriverWait(driver,30).until(ExpectedConditions.
				 * elementToBeClickable(By.xpath(pro.getProperty("ExportToExcel"
				 * )))); action.moveToElement(hoverElement).build().perform();
				 * Thread.sleep(1000);
				 * Utilities.HoverandClick(pro.getProperty("ExcelInDetail"),
				 * driver); element
				 * =wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				 * pro.getProperty("WindowExportBtn")))); element.click();
				 * Thread.sleep(1000); SikulliUtil.sikulli_waitClick(driver,
				 * "XLStype"); SikulliUtil.sikulli_waitClick(driver, "ClsX");
				 * System.out.
				 * println("* * * * * * EXPORT for [.Excel in Detail ] completed successfully * * * * * * *"
				 * ); Thread.sleep(1500);
				 * 
				 * // Excel Summary Utilities.clickButton(ExportButtonName, 500,
				 * driver); hoverElement = new
				 * WebDriverWait(driver,30).until(ExpectedConditions.
				 * elementToBeClickable(By.xpath(pro.getProperty("ExportToExcel"
				 * )))); action.moveToElement(hoverElement).build().perform();
				 * Thread.sleep(1000);
				 * Utilities.HoverandClick(pro.getProperty("ExcelInSummary"),
				 * driver); element
				 * =wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				 * pro.getProperty("WindowExportBtn")))); element.click();
				 * Thread.sleep(1000); SikulliUtil.sikulli_waitClick(driver,
				 * "XLStype"); SikulliUtil.sikulli_waitClick(driver, "ClsX");
				 * System.out.
				 * println("* * * * * * EXPORT for [.Excel Summary ] completed successfully * * * * * * *"
				 * ); Thread.sleep(1500);
				 */
