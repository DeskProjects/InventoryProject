...
public class OpeningVendorDNCreation {

	public void Create_OPVendorDN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseVendDN";
			...
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("DNTab2")))).click();
			...
			// Fill the information for Opening Vendor DN document
			...
			System.out.println(
					"\"Opening Vendor Debit Note\" is created successfully with Base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Vendor DN is not created");
	...
	// ------------------------------------------- Opening Vendor DN with
	// Foreign
	// Currency---------------------------------------------------------------------

	public void Create_OPVendorDN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			Thread.sleep(3000);
			...
			System.out.println(
					"\"Opening Vendor Debit Note\" is created successfully with foreign currency: " + documentid1);
	...
	// --------------------------------------------------------------Edit
	// Opening Vendor DN Document(Base
	// Currency)--------------------------------------

	public void Edit_OPVendorDN_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			driver.findElement(By.xpath(pro.getProperty("OpeningMemo2")))
					.sendKeys("Edit Opening Vendor DN by Automation Script");
			Thread.sleep(1000);
			...
			System.out
					.println("\"Opening Vendor Debit Note\" is edited successfully with base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening Vendor DN is not edited");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}
	...
	// --------------------------------------------------------------Edit
	// Opening Vendor DN Document(Foreign
	// Currency)--------------------------------------

	public void Edit_OPVendorDN_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			System.out.println(
					"\"Opening Vendor Debit Note\" is edited successfully with foreign currency: " + documentid1);
	...
	public void Delete_OPVendorDN_With_BaseandForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			System.out.println("Opening Vendor Debit Notes are deleted successfully");

		} catch (Exception EX) {
			System.out.println("Opening Vendor DN are not deleted");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}

	// ----------------------------------------Again Create Opening Vendor DN
	// with Base and Foreign Currency-------------------------------------------

	public void Create_OPVendorDN_With_BaseCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BaseVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
			...
			// Fill the information for Opening Vendor Debit Note document
	...
	public void Create_OPVendorDN_With_ForeignCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignVendDN";
			Properties pro = Utilities.fetchProValue("OR_DebitNoteOtherWise.properties");
	...
	// --------------------------------------- Verify Opening Vendor Debit Note
	// document through Credit Note
	// Report--------------------------------------------

	public void OpeningVendorDNDocument_Verifcation(WebDriver driver, String VendorID)
		...
		try {
			...
			if (expected.equalsIgnoreCase(actual)) {
				System.out.println("Opening Vendor Debit Note records are shown successfully");
			}
		} catch (Exception EX) {
			System.out.println("No Opening Vendor Debit Note record is shown");
