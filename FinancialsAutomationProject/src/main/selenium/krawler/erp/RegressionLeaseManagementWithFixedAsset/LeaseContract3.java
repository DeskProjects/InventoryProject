...
public class LeaseContract3 {
	private static final Properties LM = null;

	public void LM_CreateContract(String documentid, String Asset_Id, String customerid, WebDriver driver)
	...
	public static void VerifyLM_Contract(String documentid, String Asset_Id, String customerid, WebDriver driver)
	...
	public void Delete_LeaseContract(String documentid1, String Asset_Id, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
