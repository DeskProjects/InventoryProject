...
public class InventoryCS {
	...
	public static void create_AutoDoCashSale(String documentId, String productid, String customerId, WebDriver driver)
		...
		try {
			...
			System.out.println("******* AUTO BUILD ASSEMBLY DO with Cash Sale : [" + "AutoDoCS" + documentId
					+ "] is Created !!!!!! ********");

		} catch (Exception EX) {
			System.out.println("******* AUTO BUILD ASSEMBLY DO with Cash Sale is NOT Created for :[" + "AutoDoCS"
					+ documentId + "] checlk LOG *******");
	...
	// *************** Auto Build DO ***************
	public static void create_AutoDosalesInvoice(String documentId, String productid, String customerid,
		...
		try {
			...
			Utilities.enterTextNormalBox("This is AUTO BUILD ASSEMBLY Sales Invoice", "//*[@id='memo2Invoice']",
					driver);
			Utilities.clickButton("Save", 1000, driver);
			Utilities.clickButton("Yes", 1000, driver);
			Utilities.clickButton("No", 1000, driver);
			...
			System.out.println("******* AUTO BUILD ASSEMBLY DO with Sales Invoice: [" + documentId
					+ "] is Created !!!!!! ********");

		} catch (Exception EX) {
			System.out.println("******* AUTO BUILD ASSEMBLY DO with Sales Invoice is NOT Created for :[" + documentId
					+ "] checlk LOG *******");
			Utilities.handleError(EX, driver);
		}
