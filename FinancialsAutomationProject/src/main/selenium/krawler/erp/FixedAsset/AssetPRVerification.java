...
public class AssetPRVerification {
	public void Verification_AssetPR(String documentid, String ExpectedResultTA, WebDriver driver)
		...
		try {
			...
			Properties AssetPR = Utilities.fetchProValue("OR_AssetPR.properties");
			Thread.sleep(500);
			...
			WebElement APRRbutton = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPR.getProperty("ClickOnAPRR"))));
			APRRbutton.click();
			Thread.sleep(1000);
			...
			WebElement TA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPR.getProperty("TotalAmount"))));
			...
			WebElement TAB = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPR.getProperty("TotalAmountInBase"))));
			...
			WebElement GTA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPR.getProperty("GrossTotalAmount"))));
