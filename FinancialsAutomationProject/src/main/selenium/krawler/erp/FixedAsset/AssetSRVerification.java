...
public class AssetSRVerification {
	public void Verification_AssetSR(String documentid, String ExpectedResultTA, WebDriver driver)
		...
		try {
			...
			Properties AssetSR = Utilities.fetchProValue("OR_AssetSR.properties");
			Thread.sleep(500);
			...
			WebElement ASRRbutton = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetSR.getProperty("ClickOnASRR"))));
			ASRRbutton.click();
			Thread.sleep(1000);
			...
			WebElement TA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetSR.getProperty("TotalAmount"))));
			...
			WebElement GTA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetSR.getProperty("GrossTotalAmount"))));
