...
public class LeaseDeliveryOrder {
	...
	public void LM_CreateDeliveryOrder(String documentid, String productid, String customerid, WebDriver driver)
		...
		try {
			 ...
			 * elementToBeClickable(By.xpath(LM.getProperty("serialicon"))));
	...
	public static void VerifyLM_DeliveryOrder(String documentid, String productid, String customerid, WebDriver driver)
	...
	public void Delete_LeaseDelivery(String documentid1, String productid, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
