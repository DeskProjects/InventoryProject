...
public class MPRPRegressionTestingInBase {
	...
	public static String documentId = "Nsub25";
	...
	public static String BankName = "Cash";
	...
	public void createCOA2() throws InterruptedException, AWTException, IOException {
		CreatePaymethodandCOA.create_ChartOfAccount(documentID + "-2", BankName, "product", "customerid", driver);
	}

	@Test(priority = 3)
	public void PIForMP() throws InterruptedException, AWTException, IOException {
		// PurchaseInvoice1.create_PurchaseInvoice(documentId, productid,
		// vendorid, driver);
	}

	@Test(priority = 4)
	public void PIForMPGL() throws InterruptedException, AWTException, IOException {
		// PurchaseInvoice1.createGL_PurchaseInvoice(documentId, productid,
		// vendorid, driver);
	}
	...
	@Test(priority = 12)
	public void MPCustWithMultpleDoc() throws InterruptedException, AWTException, IOException {
