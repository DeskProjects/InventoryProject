...
public class LeaseOrder3 {
	private static final Properties LM = null;

	public void LM_CreateOrder(String documentid, String Asset_ID, String customerid, WebDriver driver)
			throws InterruptedException, IOException, AWTException {
		try {

			String documentid1 = "order" + documentid;
			String Asset1 = "asset" + Asset_ID;
			...
			// Close the side panel navigation
			...
			// Click on View icon for putting Asset details.
			for (int i = 1; i <= driver
				...
				if (driver.findElement(By
						.xpath("//div[@id='fixedassetleasesalesordereditproductdetailsgrid']/div/div/div/div[1]/div[1]/div[1]/div/table/thead/tr/td["
								+ i + "]/div"))
						.getText().equalsIgnoreCase("View")) {
					Utilities.HoverandClick(
							"//div[@id='fixedassetleasesalesordereditproductdetailsgrid']/div/div/div/div[1]/div[2]/div[1]/div[1]/table/tbody/tr/td["
									+ i + "]/div/div",
							driver);
					break;
				}
			...
			// Choose Asset ID from drop down
			driver.findElement(By.xpath(LM.getProperty("AssetID"))).click();
			Thread.sleep(2000);
			Utilities.sendText(Asset1 + "FA1");
			Thread.sleep(1000);
			...
			Utilities.clickAndEnterText("1000", LM.getProperty("LeaseAmount"), driver);

			Thread.sleep(1000);

			// Click on "Save" button present at Asset Detail window.
			driver.findElement(By.xpath(LM.getProperty("SaveBtnforLease1"))).click();
			Thread.sleep(1000);
			...
			System.out.println("\"Lease Order\' doucment is not created successfully");
	...
	public static void VerifyLM_Order(String documentid, String Asset_Id, String customerid, WebDriver driver)
	...
	public void Delete_LeaseOrder(String documentid1, String Asset_ID, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
