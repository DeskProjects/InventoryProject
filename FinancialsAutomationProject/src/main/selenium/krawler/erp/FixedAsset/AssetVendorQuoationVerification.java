...
public class AssetVendorQuoationVerification {
	public void Verification_AssetVQ(String documentid, String ExpectedResultTA, WebDriver driver)
		...
		try {
			...
			WebElement AVQRbutton = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetVQ.getProperty("ClickOnAVQR"))));
			AVQRbutton.click();
			Thread.sleep(1000);

			// Click On Fetch button
			WebElement Search = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetVQ.getProperty("Fetch"))));
			Search.click();
			Thread.sleep(1000);
			...
			WebElement TA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetVQ.getProperty("TotalAmount"))));
			...
			WebElement TAB = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetVQ.getProperty("TotalAmountInBase"))));
			...
			WebElement GTA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetVQ.getProperty("GrossTotalAmount"))));
