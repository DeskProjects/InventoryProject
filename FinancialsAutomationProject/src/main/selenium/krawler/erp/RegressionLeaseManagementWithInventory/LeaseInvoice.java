...
public class LeaseInvoice {
	...
	public void LM_CreateInvoice(String documentid, String productid, String customerid, WebDriver driver)
	...
	public static void VerifyLM_Invoice(String documentid, String productid, String customerid, WebDriver driver)
	...
	public void LM_Edit_LeaseInvoice(String documentid1, String productid, String customerid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
