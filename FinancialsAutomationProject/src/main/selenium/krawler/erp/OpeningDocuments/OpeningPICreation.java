...
public class OpeningPICreation {
	public void Create_OPPI_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BasePI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
			Thread.sleep(1000);
			// Click on Vendor check box
			...
			// Fill the information for Opening PI document
			...
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("PartyInvNo"))))
					.sendKeys("PartyInv123");
			Thread.sleep(1000);
			...
			System.out
					.println("\"Opening Purchase Invoice\" is created successfully with Base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening PI is not created");
	...
	// ------------------------------------------- Opening PI with Foreign
	// Currency---------------------------------------------------------------------

	public void Create_OPPI_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignPI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
			Thread.sleep(3000);
			...
			System.out.println(
					"\"Opening Purchase Invoice\" is created successfully with foreign currency: " + documentid1);
	...
	public void Edit_OPPI_With_BaseCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BasePI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
			...
			driver.findElement(By.xpath(pro.getProperty("OpeningMemo")))
					.sendKeys("Edit Opening PI by Automation Script");
			Thread.sleep(1000);
			...
			System.out
					.println("\"Opening Purchase Invoice\" is edited successfully with base currency: " + documentid1);

		} catch (Exception EX) {
			System.out.println("Opening PI is not edited");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}
	...
	public void Edit_OPPI_With_ForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignPI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
			...
			System.out.println(
					"\"Opening Purchase Invoice\" is edited successfully with foreign currency: " + documentid1);
	...
	public void Delete_OPPI_With_BasendForeignCurrency(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BasePI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
			...
			System.out.println("Opening Purchase Invoices is deleted successfully");

		} catch (Exception EX) {
			System.out.println("Opening PI is not deleted");
			Utilities.handleError(EX, driver);
		}
		Thread.sleep(1000);
	}

	// ----------------------------------------Again Create Opening PI with Base
	// and Foreign Currency-------------------------------------------

	public void Create_OPPI_With_BaseCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "BasePI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
	...
	public void Create_OPPI_With_ForeignCurrency1(String documentid, WebDriver driver)
			throws InterruptedException, AWTException, IOException {
		try {
			String documentid1 = documentid + "ForeignPI";
			Properties pro = Utilities.fetchProValue("OR_VendorInvoice.properties");
	...
	// ---------------------------------------- Verify Opening PI document
	// through Purchase Invoice Report----------------------------------------

	public void OpeningPIDocument_Verifcation(WebDriver driver, String VendorID)
		...
		try {
			...
			// Open PI Report
			new WebDriverWait(driver, 30)
					.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("PIInvoiceReport"))))
					.click();
			Thread.sleep(2000);
			...
			if (expected.equalsIgnoreCase(actual)) {
				System.out.println("Opening Purchase Invoice records are shown successfully");
			}
		} catch (Exception EX) {
			System.out.println("No Opening Purchase Invoice record is shown");
