...
public class AssetPOVerification {
	public void Verification_AssetPO(String documentid, String ExpectedResultTA, WebDriver driver)
		...
		try {
			...
			WebElement APORbutton = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPO.getProperty("ClickOnAPOR"))));
			APORbutton.click();
			Thread.sleep(1000);

			// Click On Fetch button
			WebElement Search = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPO.getProperty("Fetch"))));
			Search.click();
			Thread.sleep(1000);
			...
			WebElement TA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPO.getProperty("TotalAmount"))));
			...
			WebElement TAB = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPO.getProperty("TotalAmountInBase"))));
			...
			WebElement GTA = AGwait
					.until(ExpectedConditions.elementToBeClickable(By.xpath(AssetPO.getProperty("GrossTotalAmount"))));
